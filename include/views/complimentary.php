                    ...
                    <div class="row">
                        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 col-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="to_whom" id="to_whom" placeholder="Enter To Whom" tabindex="8">
                            </div>
                        </div>
                        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 col-4">
                            <div class="form-group">
                                <label for="purpose">Purpose</label><span class="text-danger">*</span>
                                <input type="text" class="form-control" name="purpose" id="purpose" placeholder="Enter Purpose" tabindex="9">
                            </div>
                        </div>
                        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 col-4">
                            <div class="form-group">
                        ...
                        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 col-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="complimentary_qty" id="complimentary_qty" placeholder="Complimentary Qty" tabindex="14">
                            </div>
                        </div>
                        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 col-4">
                            <div class="form-group">
                                <label for="balance_qty">Balance Qty</label><span class="text-danger">*</span>
                                <input type="text" class="form-control" name="balance_qty" id="balance_qty" placeholder="Balance Qty" tabindex="15">
                            </div>
                        </div>
                    </div>
                </div>
