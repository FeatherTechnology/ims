    ...
    <div class="radio-container" id="main_radio">
        <div class="selector">
            <div class="selector-item">
                <input type="radio" id="indent" name="customer_data_type" class="selector-item_radio" value="indent" checked>
                <label for="indent" class="selector-item_label">Indent</label>
            </div>
            <div class="selector-item">
                        ...
                        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 col-4">
                            <div class="form-group">
                                ...
                                <select type="text" class="form-control" name="indent_id" id="indent_id" placeholder="Enter Indent ID" tabindex="1">
                                    <option>Select Indent ID</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 col-4">
